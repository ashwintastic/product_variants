...
ActiveRecord::Schema[7.0].define(version: 2023_03_15_094956) do
  ...
  create_table "product_varient_options", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
  ...
  create_table "product_varients", charset: "utf8mb4", collation: "utf8mb4_0900_ai_ci", force: :cascade do |t|
    t.integer "product_id"
